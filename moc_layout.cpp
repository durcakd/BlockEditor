...
QT_MOC_LITERAL(1, 7, 16), // "childItemChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 20), // "activeContextChanged"
QT_MOC_LITERAL(4, 46, 7), // "Layout*"
QT_MOC_LITERAL(5, 54, 7) // "context"

    },
    "Layout\0childItemChanged\0\0activeContextChanged\0"
    "Layout*\0context"
};
...
void Layout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->childItemChanged(); break;
        case 1: _t->activeContextChanged((*reinterpret_cast< Layout*(*)>(_a[1]))); break;
        default: ;
        }
...
void *Layout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsLinearLayout"))
        return static_cast< QGraphicsLinearLayout*>(const_cast< Layout*>(this));
    if (!strcmp(_clname, "AbstractElement"))
        return static_cast< AbstractElement*>(const_cast< Layout*>(this));
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< Layout*>(this));
